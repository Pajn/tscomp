...
function buildBrowser() {
  ...
  checkBrowsers(paths.appPath, isInteractive)
    ...
    .then(previousFileSizes => {
      ...
      return buildWebpack(config, previousFileSizes);
    })
    .then(
...
function buildWebpack(config, previousFileSizes) {
  ...
  if (process.env.NODE_PATH) {
    console.log(
      chalk.yellow(
        'Setting NODE_PATH to resolve modules absolutely has been deprecated in favor of setting baseUrl in tsconfig.json and will be removed in a future major release of tscomp.'
      )
    );
    console.log();
  }
