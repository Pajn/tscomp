...
To get started locally, run `cd packages/tscomp-scripts/ && yarn link; cd ../../test/ && ../node_modules/.bin/jest --watchAll`.
...
- `testSetup.scripts`: an object allowing you to invoke `tscomp-scripts` commands and friends
